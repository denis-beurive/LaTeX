#!/bin/bash
#
# This file contains functions that can be used to customise your BASH environment if you use "pdflatex".
#
# Please note that "pdflatex" does not accept UTF8. The present file deals with characters encoding.
# If you are using "lualatex", then you could ignore this file.
#
